...
// source: bridge/v1beta1/conversion_pair.proto
...
type ConversionPair struct {
	...
	FuryERC20Address HexBytes `protobuf:"bytes,1,opt,name=fury_erc20_address,json=furyErc20Address,proto3,casttype=HexBytes" json:"fury_erc20_address,omitempty"`
...
func (*ConversionPair) Descriptor() ([]byte, []int) {
	return fileDescriptor_ca466ad1b76731cc, []int{0}
}
...
func init() {
	proto.RegisterType((*ConversionPair)(nil), "bridge.v1beta1.ConversionPair")
}

func init() {
	proto.RegisterFile("bridge/v1beta1/conversion_pair.proto", fileDescriptor_ca466ad1b76731cc)
}

var fileDescriptor_ca466ad1b76731cc = []byte{
	// 258 bytes of a gzipped FileDescriptorProto
	,
	...
	0xd3, 0x33, 0x4b, 0x32, 0x4a, 0x93, 0xf4, 0x92, 0xf3, 0x73, 0xf5, 0x41, 0x46, 0xeb, 0xe6, 0x24,
	0x26, 0x15, 0x43, 0x58, 0xd0, 0x50, 0xa8, 0xd0, 0x87, 0x32, 0x4a, 0x2a, 0x0b, 0x52, 0x8b, 0x93,
	0xd8, 0xc0, 0xfe, 0x32, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0x37, 0x12, 0x61, 0xee, 0x25, 0x01,
	0x00, 0x00,
}
...
func (this *ConversionPair) VerboseEqual(that interface{}) error {
	...
	if !bytes.Equal(this.FuryERC20Address, that1.FuryERC20Address) {
...
func (m *ConversionPair) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.FuryERC20Address) > 0 {
		...
		i = encodeVarintConversionPair(dAtA, i, uint64(len(m.FuryERC20Address)))
		i--
		dAtA[i] = 0xa
	}
...
func (m *ConversionPair) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.FuryERC20Address = append(m.FuryERC20Address[:0], dAtA[iNdEx:postIndex]...)
			if m.FuryERC20Address == nil {
				m.FuryERC20Address = []byte{}
			}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
