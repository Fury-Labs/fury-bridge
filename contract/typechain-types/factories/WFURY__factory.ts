...
import type { WFURY, WFURYInterface } from "../WFURY";
...
type WFURYConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: WFURYConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class WFURY__factory extends ContractFactory {
  constructor(...args: WFURYConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
      super(_abi, _bytecode, args[0]);
    }
    this.contractName = "WFURY";
  }

  deploy(
    overrides?: Overrides & { from?: string | Promise<string> }
  ): Promise<WFURY> {
    return super.deploy(overrides || {}) as Promise<WFURY>;
  }
  ...
  attach(address: string): WFURY {
    return super.attach(address) as WFURY;
  }
  connect(signer: Signer): WFURY__factory {
    return super.connect(signer) as WFURY__factory;
  }
  static readonly contractName: "WFURY";
  public readonly contractName: "WFURY";
  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): WFURYInterface {
    return new utils.Interface(_abi) as WFURYInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): WFURY {
    return new Contract(address, _abi, signerOrProvider) as WFURY;
  }
}
