...
func NewRootCmd() *cobra.Command {
	...
	rootCmd.AddCommand(
		...
		queryCommand(),
		txCommand(),
		bridgeclient.KeyCommands(app.DefaultNodeHome),
	)
...
func (a appCreator) appExport(
	...
	var ethermintApp *app.BridgeApp
	...
	if height != -1 {
		ethermintApp = app.NewApp(logger, db, traceStore, false, map[int64]bool{}, "", uint(1), a.encCfg, appOpts)

		if err := ethermintApp.LoadHeight(height); err != nil {
			return servertypes.ExportedApp{}, err
		}
	} else {
		ethermintApp = app.NewApp(logger, db, traceStore, true, map[int64]bool{}, "", uint(1), a.encCfg, appOpts)
	}
